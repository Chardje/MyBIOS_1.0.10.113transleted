...
public class p : Form
{
	...
	private void e()
	{
		if (this.m_b.c3 == "Not Installed")
		{
			this.m_b.ar = (this.m_b.cu = "Not Detected");
			ag.Visible = false;
			am.Visible = false;
			af.Visible = false;
			al.Visible = false;
		...
		aq.Text = ":" + this.m_b.c1;
		ap.Text = ":" + this.m_b.c2;
		an.Text = this.m_b.k(this.m_b.c3);
		am.Text = this.m_b.k(this.m_b.c5);
		al.Text = this.m_b.k(this.m_b.c7);
		ak.Text = this.m_b.k(this.m_b.c9);
		aj.Text = this.m_b.k(this.m_b.db);
		ai.Text = this.m_b.k(this.m_b.dd);
		ao.Text = this.m_b.k(this.m_b.df);
		a1.Text = this.m_b.o;
		d();
	}
	...
	private void c()
	{
		if (this.m_b.c3 == "Not Installed" && this.m_d != 0)
		{
			this.m_d = 0;
			return;
		}
	...
	private void b()
	{
		...
		{
		case 0:
			this.m_c = new ac(this.m_b, this.m_b.c3, this.m_b.c4);
			this.m_c.ShowDialog();
			this.m_b.c3 = this.m_b.m;
			break;
		case 1:
			this.m_c = new ac(this.m_b, this.m_b.c5, this.m_b.c6);
			this.m_c.ShowDialog();
			this.m_b.c5 = this.m_b.m;
			break;
		case 2:
			this.m_c = new ac(this.m_b, this.m_b.c7, this.m_b.c8);
			this.m_c.ShowDialog();
			this.m_b.c7 = this.m_b.m;
			break;
		case 3:
			this.m_c = new ac(this.m_b, this.m_b.c9, this.m_b.da);
			this.m_c.ShowDialog();
			this.m_b.c9 = this.m_b.m;
			break;
		case 4:
			this.m_c = new ac(this.m_b, this.m_b.db, this.m_b.dc);
			this.m_c.ShowDialog();
			this.m_b.db = this.m_b.m;
			break;
		case 5:
			this.m_c = new ac(this.m_b, this.m_b.dd, this.m_b.de);
			this.m_c.ShowDialog();
			this.m_b.dd = this.m_b.m;
			break;
		case 6:
			this.m_c = new ac(this.m_b, this.m_b.df, this.m_b.dg);
			this.m_c.ShowDialog();
			this.m_b.df = this.m_b.m;
			break;
		}
		e();
	}
	...
	private void a(bool A_0)
	{
		...
		{
		case 0:
			this.m_b.k(ref this.m_b.c3, this.m_b.c4, A_0);
			break;
		case 1:
			this.m_b.k(ref this.m_b.c5, this.m_b.c6, A_0);
			break;
		case 2:
			this.m_b.k(ref this.m_b.c7, this.m_b.c8, A_0);
			break;
		case 3:
			this.m_b.k(ref this.m_b.c9, this.m_b.da, A_0);
			break;
		case 4:
			this.m_b.k(ref this.m_b.db, this.m_b.dc, A_0);
			break;
		case 5:
			this.m_b.k(ref this.m_b.dd, this.m_b.de, A_0);
			break;
		case 6:
			this.m_b.k(ref this.m_b.df, this.m_b.dg, A_0);
			break;
		}
		e();
	}
	...
	private void a()
	{
		...
		ad.Text = "DMA Mode";
		ae.AutoSize = true;
		ae.Location = new Point(22, 529);
		ae.Name = "PIOMode";
		ae.Size = new Size(149, 34);
		ae.TabIndex = 15;
		ae.Text = "PIO Mode";
		af.AutoSize = true;
		...
		o.TabIndex = 1;
		m_p.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Right;
		m_p.BackColor = Color.FromArgb(27, 35, 165);
		m_p.Location = new Point(1266, 90);
		m_p.Name = "Vert3";
		m_p.Size = new Size(4, 879);
		m_p.TabIndex = 2;
		...
		base.Controls.Add(h);
		base.Controls.Add(g);
		base.Controls.Add(m_p);
		base.Controls.Add(n);
		base.Controls.Add(m);
		base.Controls.Add(i);
		base.Controls.Add(j);
		base.FormBorderStyle = FormBorderStyle.None;
		base.Name = "Main_SATA4_Form";
		base.StartPosition = FormStartPosition.CenterScreen;
		Text = "Main_SATA4_Form";
